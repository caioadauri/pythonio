# abrir o arquivo tanto no modo escrita quando no modo leitura usando o w+
arquivo_contatos = open('dados/contatos-escrita.csv', mode='a+')
...
# retornar ponteiro para a primeira posição do arquivo
